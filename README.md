...
> [!NOTE]  
> В случае появляения каких-либо неожиданных багов в скомпилированной игре (например, присутствие багов, которых нет в моих сборках, или игра вообще крашится), то попробуйте версию Godot Engine 4.6.2 (https://godotengine.org/download/archive/4.6.2-stable/). Это может помочь, так как именно на этой версии я сейчас сижу. Либо вы скачали исходник с коммитами, которых ещё нет в последней сборке ¯\\\_('-')_/¯.
2. Скачайте исходник
...
> [!TIP]
> Некоторые GPU не поддерживают Vulkan. Но вы можете изменить движок рендера на OpenGL. При этом графика станет хуже, а производительность может разительно изменится. В редакторе в правом верхнем углу переключите режим "Forward+" на "Совместимость"/"Compatibility".
#
